...
class English(Language):
    ...
    text_004 = "Set the chessboard in a way I could see the four inside corners."
    text_005 = "I recommend you to move forward the furthest rocks."
    text_006 = "When you have done it, press enter."
    text_007 = "Now, click on the four corners following the instructions."
    text_008 = "You can enlarge the window if you need."
    text_009 = "There is connection with Arduino."
    text_010 = "There is no connection with Arduino."
    text_011 = "The order is rock, knight and bishop."
    text_012 = "Remember kings must be in the E column."
    text_013 = "Whites start."
    text_014 = "%s by %s"
    text_015 = "%s to %s"
    text_016 = "Don't move many times the pawns, try to move other pieces."
    ...
    text_020 = "If you prefer to put manually the move, press escape."
    text_021 = "Detection error. Put the move manually."
    text_022 = "Checkmate, %s have win at turn %s, congratulations!."
    text_023 = "%s promotes."
